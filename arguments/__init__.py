...
class GuidanceParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        self.is_LCM = False
        self.LCM_LoRA = False
        self.hyper_LoRA = False
        self.LCM_model_key = None
        self.base_model_key = None
        self.LCM_LoRA_key = None

        self.controlnet_depth_model_key = None
        
        self.controlnet_normal_model_key = None
        
        self.controlnet_type = 'depth'    # 'normal' or 'depth' or 'normal&depth'

        self.perpneg =  True
        self.negative_w = -2.
        self.front_decay_factor = 2.
        self.side_decay_factor = 10.
        self.overhead_decay_factor = 10.   
        ...
        self.add_noise_multi_steps = False
        
        self.use_overhead = False
        
        self.use_control_net = False
        
        self.overhead_loss_ratio = 0
        
        self.LCM_steps_num = 2
        self.LCM_steps_num_range = None
        
        self.LCM_steps_num_range1 = None
        ...
        self.agg_first = False
        
        self.agg_last = False
        self.endpoint = True
        
        self.timestep_ratio1 = False
        self.timestep_ratio2 = False
        
        self.x0_loss = False
        self.x0_iters = 500
        self.is_PixArt = False
        # self.LCM_steps_num_x0 = 1
        self.resolution_warm_up = False
        self.first_stage_DDIM = True
        self.use_ipadapter = False
        self.is_faceid = False
        self.ip_image_path = ''
        self.ip_adapter_image_encoder_path = ''
        self.ip_adapter_ip_ckpt_plus_face = ''
        self.ip_adapter_ip_ckpt_faceid = ''
        
        self.grad_truth = False
        self.true_grad_steps = 2
        self.true_grad_interval = 100
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        self.overhead_loss = 0
        self.densify_init_iter = 30000
...
class GenerateCamParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.jitter_up = 0.01
        self.device = "cuda"
        self.init_ply_path = None
        self.use_stage1_color = True
        self.load_direct = False
        self.upsample_init_pointc = 'random'
        self.init_path= ''
